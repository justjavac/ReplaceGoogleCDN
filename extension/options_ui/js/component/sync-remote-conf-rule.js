import {fetchAll,getContent} from "/third_party/jingjingxyk/frontend-utils/utils.js"
...
let sync_remote_conf=()=> {
    ...
    document
        ...
        .addEventListener("click", (event) => {
            ...
            event.preventDefault();
            document
                .querySelector(".remote-rule-urls").value = `
...
https://www.jingjingxyk.com/chromium-extension/extension-v3-test/rules/rules_remove_content_security_policy_header.json?raw=true
            ...
            `
            document
                .querySelector(".external-page-box").innerHTML=iframe
